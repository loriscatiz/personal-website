...
function TimelineCard({
    ...
    return (
        ...
        >
            ...
            <div
                className={`timeline-card-footer rounded-b-3xl border-4 border-t-0 border-solid border-indigo-600 bg-sky-100 px-8 pb-6 text-right text-sm dark:bg-sky-950 ${index % 2 == 0 && 'lg:text-left'}`}
            >
