...
function TimelineCard({
    ...
    return (
        // <div
        //     className={`timeline-card z-10 text-sky-900 dark:text-sky-200 lg:row-span-3 
        //         ${index == 1 ? 'lg:row-start-1' : index == 2 ? 'lg:row-start-3' : index == 3 ? 'lg:row-start-5' : index == 4 ? 'lg:row-start-7' : index == 5 ? 'lg:row-start-9' : ''} /* only on big screens, make a ladder layout left right*/`}
        // >

        <div
            className={`timeline-card z-10 text-sky-900 dark:text-sky-200 lg:row-span-3 
                lg:row-start-${index * 2 + 1} /* only on big screens, make a ladder layout left right*/`}
        >
            <div
